...
struct I2c_Ipw_HwChannelConfigType
{
     ...
     *
     */
    I2c_StatusType I2c_Ipw_eChannelType;
    /**
     * @brief
     *
     */
    I2c_StatusType I2c_Ipw_LPI2CHwConfig;
    /**
     * @brief
     *
     */
    I2c_StatusType I2c_Ipw_FlexIOCHwConfig;
};
 ...
 */
FUNC(void, I2C_CODE)
I2c_Ipw_InitChannel(CONST(uint8, AUTOMATIC) u8Channel,
                    P2CONST(I2c_Ipw_HwChannelConfigType,
                            AUTOMATIC,
                            I2C_APPL_CONST) pConfigPtr)
{
    ...
    {
        I2c_FlexIO_InitChannel(u8Channel,
                               (pConfigPtr->I2c_Ipw_FlexIOCHwConfig));
    }
}

FUNC(Std_ReturnType, I2C_CODE)
I2c_Ipw_CheckDataLength(P2CONST(I2c_RequestType, AUTOMATIC, I2C_APPL_CONST)
                            pRequest,
